...
function Navbar() {
  ...
  return (
    <div  className='bg-gradient-to-r from-red-400 to-lime-400 rounded-lg sticky top-0 z-50 flex justify-between text-gray-100 text-xl  w-full md:w-full max-w-[1300px] mb-5 p-4 shadow-inner drop-shadow-sm shadow-gray-700 mx-auto items-center'>
        <Link to="contact"> <img className='h-9' src="src\assets\profilpic.png" /> </Link>
        ...
        <div className={nav?'text-center z-20 fixed h-full w-full left-0 top-0 bg-gray-600':'fixed w-screen left-[-110%]'}>
