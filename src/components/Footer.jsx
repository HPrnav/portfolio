...
function Footer() {
  return (
    <div className='bg-gradient-to-r from-orange-400 to-lime-400  rounded-lg opacity-80 grid md:flex justify-between text-gray-100 text-xl w-full mb-5 pl-4 p mx-auto items-center'>
       
       <div className='grid gap-0.5 md:flex md:gap-5'>
            ...
            <p className='font-mono italic text-gray-700'>9146810174</p>
            </div>
